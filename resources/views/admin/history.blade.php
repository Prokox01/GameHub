...
<h4 class="text-center ">Zarządaj historią gier</h4><br>
<h5>Dodaj nową historią gry</h5>
<div class="card card-default">
    <div class="card-body p-5">
        <form method="POST" action="{{url('addhistory')}}">
        @csrf
...
<h5>Zarządaj obecnymi historiami gier</h5>
...
<table class="table table-bordered" style=" border-collapse: separate; padding: 30px;">
                    ...
                    <tr>
                        ...
                        <td>{{$h['score']}}</td>
                        <td>
                            <a class="btn btn-warning" href="edit/history/{{$key}}">Edytuj</a>
                            <a class="btn btn-danger" onclick="return confirmDelete()" href="delete/history/{{$key}}">Usuń</a>
                        </td>  
                    </tr>
